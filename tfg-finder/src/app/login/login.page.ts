...
export class LoginPage {
  ...
  async iniciarSesion() {
    const loading = await this.loadingController.create({
      ...
      spinner: 'circular',  // Tipo de spinner, puedes cambiarlo (por ejemplo, 'dots', 'lines', 'bubbles', etc.)
      duration: 1000  // Duración del loading (en milisegundos), se puede ajustar o eliminar
    });
    ...
    }, 1000);  // Simula un retraso de 2 segundos, ajusta según lo necesites
  }
}